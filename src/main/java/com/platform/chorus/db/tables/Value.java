...
public class Value extends TableImpl<ValueRecord> {
    ...
    private static final long serialVersionUID = -1676991440;
     ...
     */
    public final TableField<ValueRecord, Integer> OWNER = createField("owner", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('value_owner_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");
    ...
    /**
     * The column <code>public.value.class</code>.
     */
    public final TableField<ValueRecord, String> CLASS = createField("class", org.jooq.impl.SQLDataType.VARCHAR(200), this, "");

    /**
     * The column <code>public.value.creator</code>.
     */
    public final TableField<ValueRecord, String> CREATOR = createField("creator", org.jooq.impl.SQLDataType.VARCHAR(50), this, "");

    /**
     * The column <code>public.value.description</code>.
     */
    public final TableField<ValueRecord, String> DESCRIPTION = createField("description", org.jooq.impl.SQLDataType.CLOB, this, "");
