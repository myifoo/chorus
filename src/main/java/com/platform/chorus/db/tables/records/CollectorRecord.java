...
public class CollectorRecord extends UpdatableRecordImpl<CollectorRecord> implements Record6<Integer, String, String, String[], String, String> {
    ...
    private static final long serialVersionUID = -918049940;
     ...
     */
    public CollectorRecord(Integer id, String name, String result, String[] injects, String argument, String description) {
        super(Collector.COLLECTOR);
